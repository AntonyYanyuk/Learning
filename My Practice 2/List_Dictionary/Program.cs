...
namespace Collection_with_two_means_of_one_word
{
    ...
    {
        List<Dictionary> russian_words = new List<Dictionary>();

        List<Dictionary> ukrainian_1rst_mean = new List<Dictionary>();

        List<Dictionary> ukrainian_2nd_mean = new List<Dictionary>();

        List<Dictionary> english_words = new List<Dictionary>();

private static void InitializeDictionary()
        {
            russian_words.Add(1, "Апельсин");
        ...
        public void Add()
        {
            ...
            {
                int key = english_words.Capacity;
                ...
                russian_words.Add(Key = key, Word = Rus_word);
                ...
                if (Ukr_word == "Menu")
                {
                    ...
                    Console.WriteLine("Вы в главном меню.");
                    Console.WriteLine("Сделайте ваш выбор, для справки введите: \"?\".");
                    russian_words.Remove(Key = key, Word = Rus_word);
                    break;
                }
                ukrainian_1rst_mean.Add(Key = key, Word = Ukr_word);
                ...
                if (Ukr_2word == "Menu")
                {
                    ...
                    Console.WriteLine("Сделайте ваш выбор, для справки введите: \"?\".");
                    russian_words.Remove(Key = key, Word = Rus_word);
                    ukrainian_1rst_mean.Remove(Key = key, Word = Ukr_word);
                    break;
                }
                ukrainian_2nd_mean.Add(Key = key, Word = Ukr_2word);
                ...
                if (Eng_word == "Menu")
                {
                    ...
                    russian_words.Remove(Key = key, Word = Rus_word);
                    ukrainian_1rst_mean.Remove(Key = key, Word = Ukr_word);
                    ukrainian_2nd_mean.Remove(Key = key, Word = Ukr_2word);
                    break;
                }
                english_words.Add(Key = key, Word = Eng_word);
